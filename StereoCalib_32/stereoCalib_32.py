...
def stack_and_display_images(images1, images2, stack_horizontal=True, display_time=1500):
    for img_x, img_y in zip(images1, images2):
        ...
        cv2.imshow('CAM 3-2', stacked_img)
...
def visualize_reprojection_error(image_path_x, imgpoints_x, imgpoints_projx,
    ...
    cvzone.putTextRect(img_x, 'Cam3', (7, 20), font_scale, thickness, RED, BLACK, font)
    cvzone.putTextRect(img_y, 'Cam2', (7, 20), font_scale, thickness, RED, BLACK, font)
...
def calculate_reprojection_error_stereo(objpoints, imgpoints_x, imgpoints_y, cam_mtx_x, dist_mtx_x,
    ...
    tot_error = 0
    total_points = 0
    camImages_x = "StereoImages/Camera 3"
    camImages_y = "StereoImages/Camera 2"
    global mean_error
...
def main():
    ...
    objpoints, imgpoints_x, images_with_corners_x = find_chessboard_corners(camImages_3, pattern_size, square_size,
                                                                          visualize=True)
    objpoints, imgpoints_y, images_with_corners_y = find_chessboard_corners(camImages_2, pattern_size, square_size,
                                                                          visualize=True)
    ...
    np.savez('stereo_calib_params/stereo_calib/calib_data32.npz',
             Camera_matrix_3=cam_mtx_x, Distortion_matrix_3=dist_mtx_x,
             Camera_matrix_2=cam_mtx_y, Distortion_matrix_2=dist_mtx_y,
    ...
    cam_mtx_x_RS, dist_mtx_x_RS = get_builtinIntrinsics(CAM_3)
    cam_mtx_y_RS, dist_mtx_y_RS = get_builtinIntrinsics(CAM_2)
    ...
    np.savez('stereo_calib_params/stereo_calib_realsense/calib_data_RS32.npz',
             Camera_matrix_3=cam_mtx_x_RS, Distortion_matrix_3=dist_mtx_x_RS,
             Camera_matrix_2=cam_mtx_y_RS, Distortion_matrix_2=dist_mtx_y_RS,
