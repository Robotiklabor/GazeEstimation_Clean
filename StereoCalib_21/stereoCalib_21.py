...
def stack_and_display_images(images1, images2, stack_horizontal=True, display_time=1500):
    for img_x, img_y in zip(images1, images2):
        ...
        cv2.imshow('CAM 2-1', stacked_img)
...
def visualize_reprojection_error(image_path_x, imgpoints_x, imgpoints_projx,
    ...
    cvzone.putTextRect(img_x, 'Cam2', (7, 20), font_scale, thickness, RED, BLACK, font)
    cvzone.putTextRect(img_y, 'Cam1', (7, 20), font_scale, thickness, RED, BLACK, font)
...
def calculate_reprojection_error_stereo(objpoints, imgpoints_x, imgpoints_y, cam_mtx_x, dist_mtx_x,
    ...
    tot_error = 0
    total_points = 0
    camImages_x = "StereoImages/Camera 2"
    camImages_y = "StereoImages/Camera 1"
    global mean_error
...
def main():
    ...
    CAM_2 = '023422071056'
    CAM_1 = '831612073374'
    camImages_2 = 'StereoImages/Camera 2'
    camImages_1 = 'StereoImages/Camera 1'

    objpoints, imgpoints_x, images_with_corners_x = find_chessboard_corners(camImages_2, pattern_size, square_size,
                                                                            visualize=True)
    objpoints, imgpoints_y, images_with_corners_y = find_chessboard_corners(camImages_1, pattern_size, square_size,
                                                                            visualize=True)
    ...
    np.savez('stereo_calib_params/stereo_calib/calib_data21.npz',
             Camera_matrix_2=cam_mtx_x, Distortion_matrix_2=dist_mtx_x,
             Camera_matrix_1=cam_mtx_y, Distortion_matrix_1=dist_mtx_y,
    ...
    cam_mtx_x_RS, dist_mtx_x_RS = get_builtinIntrinsics(CAM_2)
    cam_mtx_y_RS, dist_mtx_y_RS = get_builtinIntrinsics(CAM_1)
    ...
    np.savez('stereo_calib_params/stereo_calib_realsense/calib_data_RS21.npz',
             Camera_matrix_2=cam_mtx_x_RS, Distortion_matrix_2=dist_mtx_x_RS,
             Camera_matrix_1=cam_mtx_y_RS, Distortion_matrix_1=dist_mtx_y_RS,
