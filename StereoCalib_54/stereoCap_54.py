...
def capture_images_from_camera(serial_number, total_images, delay, folder_name, countdown_time=2):
    ...
    try:
        while image_count < total_images:
            ...
            if folder_name == 'StereoImages/Camera 5':
            ...
            elif folder_name == 'StereoImages/Camera 4':
                cv2.namedWindow(f'Realsense {serial_number}')  # Create window with default properties
...
def main():
    ...
    CAM_5 = '828612061411'
    CAM_4 = '830112071254'
    folder_name_5 = 'StereoImages/Camera 5'
    folder_name_4 = 'StereoImages/Camera 4'

    thread_5 = threading.Thread(target=capture_images_from_camera,
                                args=(CAM_5, total_images, delay, folder_name_5))
    thread_4 = threading.Thread(target=capture_images_from_camera,
                                args=(CAM_4, total_images, delay, folder_name_4))
    thread_5.start()
    thread_4.start()
    thread_5.join()
    thread_4.join()
