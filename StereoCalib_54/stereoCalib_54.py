...
def stack_and_display_images(images1, images2, stack_horizontal=True, display_time=1500):
    for img_x, img_y in zip(images1, images2):
        ...
        cv2.imshow('CAM 5-4', stacked_img)
...
def visualize_reprojection_error(image_path_x, imgpoints_x, imgpoints_projx,
    ...
    cvzone.putTextRect(img_x, 'Cam5', (7, 20), font_scale, thickness, RED, BLACK, font)
    cvzone.putTextRect(img_y, 'Cam4', (7, 20), font_scale, thickness, RED, BLACK, font)
...
def calculate_reprojection_error_stereo(objpoints, imgpoints_x, imgpoints_y, cam_mtx_x, dist_mtx_x,
    ...
    tot_error = 0
    total_points = 0
    camImages_x = "StereoImages/Camera 5"
    camImages_y = "StereoImages/Camera 4"
    global mean_error
...
def main():
    ...
    CAM_5 = '828612061411'
    CAM_4 = '830112071254'
    camImages_5 = 'StereoImages/Camera 5'
    camImages_4 = 'StereoImages/Camera 4'

    objpoints, imgpoints_x, images_with_corners_x = find_chessboard_corners(camImages_5, pattern_size, square_size,
                                                                          visualize=True)
    objpoints, imgpoints_y, images_with_corners_y = find_chessboard_corners(camImages_4, pattern_size, square_size,
                                                                          visualize=True)
    ...
    np.savez('stereo_calib_params/stereo_calib/calib_data54.npz',
             Camera_matrix_5=cam_mtx_x, Distortion_matrix_5=dist_mtx_x,
             Camera_matrix_4=cam_mtx_y, Distortion_matrix_4=dist_mtx_y,
    ...
    cam_mtx_x_RS, dist_mtx_x_RS = get_builtinIntrinsics(CAM_5)
    cam_mtx_y_RS, dist_mtx_y_RS = get_builtinIntrinsics(CAM_4)
    ...
    np.savez('stereo_calib_params/stereo_calib_realsense/calib_data_RS54.npz',
             Camera_matrix_5=cam_mtx_x_RS, Distortion_matrix_5=dist_mtx_x_RS,
             Camera_matrix_4=cam_mtx_y_RS, Distortion_matrix_4=dist_mtx_y_RS,
